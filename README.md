# com-chilipeppr-workspace-Pasha
A ChiliPeppr Workspace Pasha.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Pasha
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-Pasha |
| Name                  | Workspace / Pasha |
| Description           | A ChiliPeppr Workspace Pasha. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/https://master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/root/PavelYa |
| Github URL            | http://github.com/https:/ |
| Test URL              | https://preview.c9users.io/root/PavelYa/workspace.html |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-Pasha"], // the id you gave your workspace
      function(myWorkspacePasha) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Pasha just got loaded.", myWorkspacePasha);
        myWorkspacePasha.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-Pasha"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Pasha"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace Pasha."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/https://master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/root/PavelYa"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/https:/"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://PavelYa-root.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
